...
1. Download the repository and extract all files into a single folder. Make sure you delete  `mamba_best_model.pth`, `scaler_mamba.pkl`, `patchtst_best_model.pth`, and `scaler_patchtst.pkl`  files (which already exist in this repo) beforehand, as they will be overwritten after training.
